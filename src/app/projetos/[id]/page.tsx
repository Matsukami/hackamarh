...
export default function ProjetoDetalhePage({ params }: { params: { id: string } }) {
  return (
    <div className="container mx-auto max-w-4xl px-4 py-12">
      <Link 
        href="/transparencia"
        className="mb-8 inline-flex items-center gap-2 text-sm font-bold text-mata-alta hover:text-cerrado-profundo transition-colors"
      >
      ...
      <Card className="overflow-hidden border-gray-200">
        <div className="h-48 w-full bg-gray-100 flex items-center justify-center">
          <span className="text-gray-400 font-sora font-bold uppercase tracking-widest">Imagem do Projeto</span>
        </div>
        <CardContent className="p-8">
          ...
          <p className="mb-6 font-dm-sans text-gray-600">
            Esta página está em construção. Aqui serão exibidos todos os detalhes, metas e indicadores financeiros específicos do projeto JREDD+ selecionado.
          </p>
